...
class GoogleMapsScraper:
    ...
    def sort_by_date(self, url):
        ...
        while not clicked and tries < MAX_RETRY:
            try:
                ...
                #else:
                # menu_bt = wait.until(EC.element_to_be_clickable((By.XPATH, '//button[@data-value=\'Sort\']'))) # en-GB
                menu_bt = wait.until(EC.element_to_be_clickable((By.XPATH, '//button[@data-value=\'Urutkan\']'))) # id
                menu_bt.click()
    ...
    def sort_by_relevance(self, url):
        self.driver.get(url)
        wait = WebDriverWait(self.driver, MAX_WAIT)
    ...
    def get_element_count(self):
        elements = self.driver.find_elements_by_xpath("//div[@class='section-review ripple-container GLOBAL__gm2-body-2']")
    ...
    def del_element(self):
        self.driver.execute_script("return document.getElementsByClassName('section-review ripple-container GLOBAL__gm2-body-2')[0].remove();")
        self.driver.execute_script("return document.getElementsByClassName('section-divider')[0].remove();")
        self.driver.execute_script("return document.getElementsByClassName('section-divider section-divider-bottom-line')[0].remove();")
